...
class _BasePage extends State<BasePage> {
    ...
    if (user.isHost && !user.isVerifiedHost) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        ...
        Navigator.of(context).push(
          MaterialPageRoute(builder: (_) => const HostConfirmIdentityPage()),
        );
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final userNavItems = [
      ...
      BottomNavigationBarItem(
          icon: ImageIcon(
            AssetImage('assets/icons/ticket-empty.png'),
          ),
          activeIcon: ImageIcon(
            AssetImage('assets/icons/ticket-filled.png'),
          ),
          label: 'Your events'),
      BottomNavigationBarItem(
    ...
    return Scaffold(
        bottomNavigationBar: Container(
          ...
          child: BottomNavigationBar(
            ...
            items: isHost == true ? hostNavItems : userNavItems,
          ),
        ),
        body: activePage);
  }
