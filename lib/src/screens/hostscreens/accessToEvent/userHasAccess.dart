...
class UserHasAccess extends StatelessWidget {

  const UserHasAccess({super.key, required this.userData, required this.eventID});
  ...
  Widget build(context) {
    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 23, 177, 30), // set the background color to green
      body: Padding(
